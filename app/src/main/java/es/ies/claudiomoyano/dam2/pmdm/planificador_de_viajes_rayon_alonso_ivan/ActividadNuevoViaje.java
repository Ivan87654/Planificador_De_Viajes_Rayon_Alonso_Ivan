...
public class ActividadNuevoViaje extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        skbPresupuesto.setOnSeekBarChangeListener(
                new SeekBar.OnSeekBarChangeListener() {
                    ...
                    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                        // acción al cambiar el valor del presupuesto
                    }
        ...
        // --- Botón GUARDAR: muestra el DialogFragment ---
        btnGuardarViaje.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                ConfirmarGuardarDialogo dialogo = new ConfirmarGuardarDialogo();
                dialogo.show(getSupportFragmentManager(), "confirmar_guardar");
            }
        });
        ...
        btnSeleccionarImagen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Comprobar si ya tenemos el permiso
                if (ContextCompat.checkSelfPermission(
                        ActividadNuevoViaje.this,
                        android.Manifest.permission.CAMERA)
                        != PackageManager.PERMISSION_GRANTED) {

                    // No está concedido: lo pedimos en tiempo de ejecución
                    ...
                    // (no es necesario implementarlo para la práctica)
                }
            }
        });
    }

    // Respuesta del usuario al cuadro de diálogo del permiso
    @Override
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (requestCode == CODIGO_PERMISO_CAMARA) {
            if (grantResults.length > 0 &&
                ...
                // Permiso concedido: aquí podríamos abrir la cámara
            } else {
                // Permiso denegado: no se puede usar la cámara
            }
        }
    }
}